...
void AstroFileInfo :: fileUpdated(AstroFile::Members)
 {
  QString date      = file()->getLocalTime().date().toString(Qt::DefaultLocaleLongDate);
...
void MainWindow        :: addToolBarActions   ( )
 {
  ...
  //toolBar     -> addAction(QIcon("style/print.png"), tr("Ёкспорт"));
  ...
  //toolBar     -> actions()[3]->setStatusTip(tr("ѕечать или экспорт \n Ctrl+P"));
  ...
  //toolBar2    -> addAction(QIcon("style/coffee.png"), tr("—правка"));
